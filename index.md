...
<ul align="justify" style="font-size:0.75em"> 
  <li style="padding-bottom: clamp(10px, 1vh, 10px)">tPhD in Neuroscience, University of Zurich, Switzerland</li>
  <li style="padding-bottom: clamp(10px, 1vh, 10px)">MS in Molecular Bioengineering, Technical University of Dresden, Germany</li>
